...
namespace flux::ast {
   ...
   ======================= */
    ...
    struct CharExpr : Expr {
        ...
        explicit CharExpr(std::string v)
            : value(std::move(v)) {
        }
    };
    ...
    struct UnaryExpr : Expr {
        ...
        UnaryExpr(TokenKind op, ExprPtr expr)
    ...
    struct CastExpr : Expr {
        ...
        CastExpr(ExprPtr e, std::string type)
            : expr(std::move(e)), target_type(std::move(type)) {}
    };
    ...
    struct LetStmt : Stmt {
        ...
        LetStmt(std::string name, std::string type, bool mut, bool is_const, ExprPtr init)
            : name(std::move(name)), type_name(std::move(type)), is_mutable(mut), is_const(is_const), initializer(std::move(init)) {}
    };
    ...
    struct ForStmt : Stmt {
        ...
        ForStmt(std::string var, std::string type, ExprPtr iter, StmtPtr body)
            : variable(std::move(var)), var_type(std::move(type)),
    ...
    struct EnumDecl : Node {
        ...
        EnumDecl(std::string name, std::vector<std::string> type_params, std::vector<Variant> variants)
            : name(std::move(name)), type_params(std::move(type_params)), variants(std::move(variants)) {}
    };
    ...
    struct ImplBlock : Node {
        ...
        ImplBlock(std::vector<std::string> type_params, std::string target, std::vector<FunctionDecl> methods)
            : type_params(std::move(type_params)), target_name(std::move(target)), methods(std::move(methods)) {}
    };
    ...
    struct TraitDecl : Node {
        ...
        TraitDecl(std::string name, std::vector<std::string> type_params, std::vector<FunctionDecl> methods)
    ...
    struct Import : Node {
        ...
        explicit Import(std::string path)
